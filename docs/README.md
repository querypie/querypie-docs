...
| 디렉토리 | 설명 |
|----------|------|
| [plans/](plans/) | 기능 구현 계획 문서 |

### 작업 결과

| 디렉토리 | 설명 |
|----------|------|
| [proofreading/](proofreading/) | 문서 교정/교열 결과 (`.agents/skills/proofread/SKILL.md` Skill에서 사용) |

## Skills와의 관계

AI Agent용 Skill 문서는 `.agents/skills/`에 있으며, 상세 지침은 이 디렉토리의 문서를 참조합니다:

- `.agents/skills/translation/SKILL.md` → `docs/translation.md`
- `.agents/skills/commit/SKILL.md` → `docs/commit-pr-guide.md`
- `.agents/skills/mdx-skeleton-comparison/SKILL.md` → `docs/translation.md`
- `.agents/skills/code-review/SKILL.md` → `docs/DEVELOPMENT.md`
