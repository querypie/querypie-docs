...
> 상태: Superseded
> 대체 문서: [`openspec/changes/complete-reverse-sync/design.md`](../../../openspec/changes/complete-reverse-sync/design.md)
> 비고: 이 문서는 2026-03 시점의 phase 계획과 당시의 코드 상태를 보존하기 위한 기록입니다. 현재 계약과 작업 계획은 OpenSpec change를 기준으로 합니다.
