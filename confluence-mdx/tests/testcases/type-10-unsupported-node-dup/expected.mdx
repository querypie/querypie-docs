...
<img src="testcases/type-10-unsupported-node-dup/output/screenshot-20240613-174843.png" alt="screenshot-20240613-174843.png" width="760" />
</figure>
...
<figure data-layout="center" data-align="center">
<img src="testcases/type-10-unsupported-node-dup/output/image-20240714-054222.png" alt="Administrator &gt; General &gt; User Management &gt; Provisioning" width="760" />
<figcaption>
...
따라서, 보다 원활한 계정 플로우 관리를 위해 [SSO 계정 시스템 연동](#unexpected-failure)의 절차를 먼저 진행하는 것을 권장드립니다.
...
* [Provisioning 활성화 하기](#unexpected-failure)
* [[Okta] 프로비저닝 연동 가이드](#unexpected-failure)
