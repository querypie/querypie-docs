...
시작하기 전에 QueryPie 설치를 위해 namespace를 만듭니다.
```
...
MySQL은 QueryPie의 메타데이터를 저장하는 데이터베이스입니다.
...
Redis는 QueryPie의 세션 및 캐시 저장소입니다.
...
Helm을 사용하여 QueryPie ACP를 설치합니다.

QueryPie ACP의 [제품 버전](../product-versions)에 따라 Helm 버전을 선택합니다.
