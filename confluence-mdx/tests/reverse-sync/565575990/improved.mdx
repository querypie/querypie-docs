...
QueryPie Server Agent 설치 후, QueryPie 내 Servers 메뉴에 Windows Server가 자동으로 추가됩니다.
...
기존처럼 다운로드 링크의 페이지를 사용해서 다운로드받을 수도 있습니다.
...
10.2.8 버전부터는 RDP 연결에 사용할 Port를 CONFIG 파일에서 지정할 수 있습니다.
</Callout>
