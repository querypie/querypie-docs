...
QueryPie Access Control Platform (ACP)는 **DAC, SAC, KAC, WAC**를 하나의 통합 플랫폼에서 제공하는 접근통제 솔루션입니다.
...
### 처음 사용하시나요?
QueryPie ACP를 처음 접하는 분들을 위한 가이드입니다.

<DescriptionCards num="2">
  <DescriptionCards.Card
    title="Overview"
    description="제품 전체를 이해하기 위한 소개, 주요 특징을 설명합니다."
    href="/ko/overview"
    icon={<BookOpenIcon />}
    arrow
  />
  <DescriptionCards.Card
    title="사용자 매뉴얼"
    description="대상 시스템에 접근하는 이용자를 대상으로 사용법을 안내합니다."
    href="/ko/user-manual"
    icon={<UserIcon />}
    arrow
  />
...
<DescriptionCards num="2">
  <DescriptionCards.Card
    title="관리자 매뉴얼"
    description="연결하려는 시스템의 설정, 접근제어와 감사로깅을 위한 보안정책을 관리하는 방법을 안내합니다."
  ...
  <DescriptionCards.Card
    title="Release Notes"
    description="최신 릴리스에 대한 정보, 기능 개선사항과 버그픽스 내역을 안내합니다."
  ...
  <DescriptionCards.Card
    title="제품 설치와 기술지원"
    description="제품 설치, 인프라 구성, MCP 설정 등 기술지원 정보를 제공합니다."
...
유효기간 만료 후에도 Community Edition 라이선스를 무료로 연장하여 사용할 수 있습니다.
