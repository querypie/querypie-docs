...
![Admin &gt; Web Apps &gt; Create a Web App](/administrator-manual/web-apps/wac-quickstart/screenshot-20250412-225620.png){width=565 .mx-auto .block}
<figcaption>
...
<figure data-layout="center" data-align="center">
![Admin &gt; Web Apps &gt; Web App Access Control &gt; Policies &gt; Edit Policy Code](/administrator-manual/web-apps/wac-quickstart/screenshot-20250412-230727.png){width=565 .mx-auto .block}
<figcaption>
...
<figure data-layout="center" data-align="center">
![Admin &gt; Web Apps &gt; Web App Access Control &gt; Roles &gt; List Details](/administrator-manual/web-apps/wac-quickstart/screenshot-20250330-204911.png){width=565 .mx-auto .block}
<figcaption>
...
<figure data-layout="center" data-align="center">
![Admin &gt; Web Apps &gt; Web App Access Control &gt; Access Control &gt; List Details](/administrator-manual/web-apps/wac-quickstart/screenshot-20250330-204937.png){width=565 .mx-auto .block}
<figcaption>
...
1. QueryPie에 로그인한 상태에서 상단 우측 프로필 버튼을 클릭하고, 프로필 메뉴에서 Support &gt; Download Web Secure 버튼을 클릭합니다.<br/> <br/> 
  <figure data-layout="center" data-align="center">
  ![QueryPie &gt; Profile Menu](/administrator-manual/web-apps/wac-quickstart/screenshot-20241223-120321.png){width=565 .mx-auto .block}
  <figcaption>
...
2. QueryPie Web Secure Download 모달이 열립니다.  **A. Install Root CA Certificate**  에서, Step 1. 내 Download Link를 클릭하면 인증서 파일 다운로드가 실행됩니다. <br/> <br/> 
  <figure data-layout="center" data-align="center">
  ![QueryPie Web Secure Download](/administrator-manual/web-apps/wac-quickstart/screenshot-20250116-155957.png){width=565 .mx-auto .block}
  <figcaption>
...
3. 전달받은 Extension 파일의  **압축을 풀지 않은**  상태로, 확장 프로그램 영역으로 끌어넣습니다.<br/> <br/> 
  <figure data-layout="center" data-align="center">
  ![Chrome &gt; 확장 프로그램 관리](/administrator-manual/web-apps/wac-quickstart/screenshot-20241219-192626.png){width=565 .mx-auto .block}
  <figcaption>
  Chrome &gt; 확장 프로그램 관리
  </figcaption>
  </figure>
4. 새 탭에서 Host Configuration 페이지가 열립니다. QueryPie Host에 현재 사용중인 QueryPie 주소를 붙여넣고, `Continue` 버튼을 클릭합니다. 
    1. Host 정보가 유효하다면 `Go to Dashboard` 버튼이 나타납니다. 클릭하면 새 탭에서 QueryPie로 진입합니다.<br/>
      <figure data-layout="center" data-align="center">
      ![Host Configuration 페이지](/administrator-manual/web-apps/wac-quickstart/screenshot-20241219-192931.png){width=565 .mx-auto .block}
      <figcaption>
...
2. Web App Dashboard 내 My Apps에 앞에서 등록한 QueryPie Web Site 앱 아이콘이 보일 것입니다. 아이콘을 클릭하면 웹사이트로 접속합니다.<br/> <br/> 
  <figure data-layout="center" data-align="center">
  ![QueryPie &gt; Web Apps &gt; Web App Dashboard](/administrator-manual/web-apps/wac-quickstart/screenshot-20250412-224323.png){width=565 .mx-auto .block}
  <figcaption>
...
3. 최초 접속 시, 현재 웹 세션이 기록되고 있음을 알려주는 화면이 보입니다. `Continue` 버튼을 클릭하여 웹사이트로 접근합니다.<br/> <br/> 
  <figure data-layout="center" data-align="center">
  ![Web Session Monitoring Notification](/administrator-manual/web-apps/wac-quickstart/screenshot-20241223-113541.png){width=565 .mx-auto .block}
  <figcaption>
...
5. 허용되지 않은 페이지 (예: Products 메뉴) 에 접근을 시도하는 경우 차단 안내 화면으로 리다이렉션 됩니다. <br/> 
  <figure data-layout="center" data-align="center">
  ![ QueryPie Access Denied](/administrator-manual/web-apps/wac-quickstart/screenshot-20241223-113037.png){width=565 .mx-auto .block}
  <figcaption>
...
<figure data-layout="center" data-align="center">
![Admin &gt; Audit &gt; Web Apps &gt; Web Access History](/administrator-manual/web-apps/wac-quickstart/screenshot-20241223-115604.png){width=589 .mx-auto .block}
<figcaption>
...
<figure data-layout="center" data-align="center">
![Admin &gt; Audit &gt; Web Apps &gt; User Activity Recordings &gt; Details](/administrator-manual/web-apps/wac-quickstart/screenshot-20241223-115805.png){width=589 .mx-auto .block}
<figcaption>
