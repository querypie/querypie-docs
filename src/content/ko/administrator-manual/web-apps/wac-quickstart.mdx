...
2. `Create a Web App` 버튼을 클릭하면 웹 앱 등록 페이지로 진입합니다.<br/>

<figure data-layout="center" data-align="center">
<img src="/administrator-manual/web-apps/wac-quickstart/screenshot-20250412-225620.png" alt="Admin &gt; Web Apps &gt; Create a Web App" width="565" />
<figcaption>
...
2. Base URL : `querypie.com` 또는 `10.10.10.10:443`
    ...
    2. Base URL에 `https://` 를 입력하면 오류 메시지가 표시됩니다.
    3. Base URL에 `www.` 를 입력하면 오류 메시지가 표시됩니다.
3. Description : 웹 앱에 대한 설명을 입력하세요. (예: 쿼리파이 웹사이트)
4. Watermark : 웹 앱 접속 시 사용자의 브라우저 화면에 워터마크를 적용할지 여부를 선택합니다.
    1. 웹 앱 접속 시 브라우저에 접속자, 접속일시 등의 정보를 표시함으로써 화면 유출을 방지합니다.
    2. 가이드에서는 On 상태를 가정하고 안내하겠습니다.
5. URL Paths : 하위 경로를 입력합니다. (선택)
...
1. User Activity Recording : 사용자 행위 기록 여부
...
<figure data-layout="center" data-align="center">
<img src="/administrator-manual/web-apps/wac-quickstart/screenshot-20250412-230727.png" alt="Admin &gt; Web Apps &gt; Web App Access Control &gt; Policies &gt; Edit Policy Code" width="565" />
<figcaption>
...
2. `Create Policy` 버튼을 클릭하고, Create Policy 모달에 다음을 입력하세요.
    1. Name : QP Web Test
...
6. `Save Changes` 버튼을 클릭하고, 사유 입력 모달에서 `OK` 버튼을 눌러 저장합니다.
...
<figure data-layout="center" data-align="center">
<img src="/administrator-manual/web-apps/wac-quickstart/screenshot-20250330-204911.png" alt="Admin &gt; Web Apps &gt; Web App Access Control &gt; Roles &gt; List Details" width="565" />
<figcaption>
...
2. `Create Role` 버튼을 클릭하고 다음을 입력합니다.
    1. Name : QP Web Test
...
<figure data-layout="center" data-align="center">
<img src="/administrator-manual/web-apps/wac-quickstart/screenshot-20250330-204937.png" alt="Admin &gt; Web Apps &gt; Web App Access Control &gt; Access Control &gt; List Details" width="565" />
<figcaption>
...
2. 역할을 할당하려는 사용자 또는 그룹을 선택합니다.
    1. 지금은 테스트 중인 본인을 선택해봅니다.
3. 사용자 상세 페이지 &gt; Roles 탭에서, `Grant Roles` 버튼을 클릭합니다.
4. Grant Roles 모달에서 방금 생성한 QP Web Test 를 선택하고, `Grant` 버튼을 클릭하여 저장합니다.
...
1. QueryPie에 로그인한 상태에서 상단 우측 프로필 버튼을 클릭하고, 프로필 메뉴에서 Support &gt; Download Web Secure 버튼을 클릭합니다.<br/> <br/>
  <figure data-layout="center" data-align="center">
  <img src="/administrator-manual/web-apps/wac-quickstart/screenshot-20241223-120321.png" alt="QueryPie &gt; Profile Menu" width="565" />
  <figcaption>
  QueryPie &gt; Profile Menu
  </figcaption>
  </figure>
2. QueryPie Web Secure Download 모달이 열립니다. **A. Install Root CA Certificate** 에서, Step 1. 내 Download Link를 클릭하면 인증서 파일 다운로드가 실행됩니다. <br/> <br/>
  <figure data-layout="center" data-align="center">
  <img src="/administrator-manual/web-apps/wac-quickstart/screenshot-20250116-155957.png" alt="QueryPie Web Secure Download" width="565" />
  <figcaption>
...
3. 전달받은 Extension 파일의 **압축을 풀지 않은** 상태로, 확장 프로그램 영역으로 끌어넣습니다.<br/> <br/>
  <figure data-layout="center" data-align="center">
  <img src="/administrator-manual/web-apps/wac-quickstart/screenshot-20241219-192626.png" alt="Chrome &gt; 확장 프로그램 관리" width="565" />
  <figcaption>
  Chrome &gt; 확장 프로그램 관리
  </figcaption>
  </figure>
4. 새 탭에서 Host Configuration 페이지가 열립니다. QueryPie Host에 현재 사용 중인 QueryPie 주소를 붙여넣고, `Continue` 버튼을 클릭합니다.
    1. Host 정보가 유효하다면 `Go to Dashboard` 버튼이 나타납니다. 클릭하면 새 탭에서 QueryPie로 진입합니다.<br/>
      <figure data-layout="center" data-align="center">
      <img src="/administrator-manual/web-apps/wac-quickstart/screenshot-20241219-192931.png" alt="Host Configuration 페이지" width="565" />
      <figcaption>
...
1. `Go to Dashboard` 버튼을 클릭하여 새 탭이 열리고 QueryPie Web 콘솔이 열립니다.
...
2. Web App Dashboard 내 My Apps에 앞에서 등록한 QueryPie Web Site 앱 아이콘이 보일 것입니다. 아이콘을 클릭하면 웹사이트로 접속합니다.<br/> <br/>
  <figure data-layout="center" data-align="center">
  <img src="/administrator-manual/web-apps/wac-quickstart/screenshot-20250412-224323.png" alt="QueryPie &gt; Web Apps &gt; Web App Dashboard" width="565" />
  <figcaption>
  QueryPie &gt; Web Apps &gt; Web App Dashboard
  </figcaption>
  </figure>
3. 최초 접속 시, 현재 웹 세션이 기록되고 있음을 알려주는 화면이 보입니다. `Continue` 버튼을 클릭하여 웹사이트로 접근합니다.<br/> <br/>
  <figure data-layout="center" data-align="center">
  <img src="/administrator-manual/web-apps/wac-quickstart/screenshot-20241223-113541.png" alt="Web Session Monitoring Notification" width="565" />
  <figcaption>
  Web Session Monitoring Notification
  </figcaption>
  </figure>
4. QueryPie 홈페이지에 Watermark가 적용된 것을 확인할 수 있습니다. <br/>
5. 허용되지 않은 페이지 (예: Products 메뉴) 에 접근을 시도하는 경우 차단 안내 화면으로 리다이렉션 됩니다. <br/>
  <figure data-layout="center" data-align="center">
  <img src="/administrator-manual/web-apps/wac-quickstart/screenshot-20241223-113037.png" alt=" QueryPie Access Denied" width="565" />
  <figcaption>
...
<figure data-layout="center" data-align="center">
<img src="/administrator-manual/web-apps/wac-quickstart/screenshot-20241223-115604.png" alt="Admin &gt; Audit &gt; Web Apps &gt; Web Access History" width="589" />
<figcaption>
...
2. 현재 사용자가 접근한 웹 앱 접근 기록을 조회할 수 있습니다.
    1. Action Type : 웹 앱 접근의 시작과 종료
        1. Connect : 접근 시작
...
<Callout type="info">
Web App 생성 시 User Activity Recording을 켜야만 기록이 남습니다.
</Callout>


<figure data-layout="center" data-align="center">
<img src="/administrator-manual/web-apps/wac-quickstart/screenshot-20241223-115805.png" alt="Admin &gt; Audit &gt; Web Apps &gt; User Activity Recordings &gt; Details" width="589" />
<figcaption>
...
3. Event Timeline에서 사용자의 행위를 시간 순서대로 확인할 수 있습니다.
    1. 필터를 클릭하면 행위 종류 별로 확인 가능합니다.
    2. 검색 가능한 값은 다음과 같습니다.
