...
또한 하나의 Job을 통해 여러 서버의 계정 패스워드를 변경하기 위해서는, 각 서버에 같은 계정명과 패스워드로 Job에서 사용할 서버 계정을 생성해야 합니다.
</Callout>
...
<Callout type="info">
Provisioning Information 계정의 패스워드를 주기적으로 변경하기 위해서는, Server Group에 계정이 등록되어야 합니다.
</Callout>
