...
커넥션 접속 시 계정의 인증 방식이 SSH Key인 경우, 미리 이곳에서 키를 등록하여 저장해 둘 수 있습니다.
이렇게 등록해 둔 키는 서버 또는 서버 그룹에서 Account 항목 등록 시 Auth Type을 SSH Key로 설정하여 불러올 수 있습니다.


### SSH Key 등록하기

<figure data-layout="center" data-align="center">
<img src="/administrator-manual/servers/server-account-management/ssh-key-configurations/image-20240828-012337.png" alt="Administrator &gt; Servers &gt; Server Account Management &gt; SSH Key Configurations &gt; Create SSH Key" width="751" />
<figcaption>
...
<figure data-layout="center" data-align="center">
<img src="/administrator-manual/servers/server-account-management/ssh-key-configurations/image-20240828-012530.png" alt="Administrator &gt; Servers &gt; Server Account Management &gt; SSH Key Configurations &gt; SSH Key Details" width="752" />
<figcaption>
