...
![Administrator &gt; Servers &gt; Server Access Control &gt; Command Templates](/administrator-manual/servers/server-access-control/command-templates/image-20240902-053009.png){width=760 .mx-auto .block}
<figcaption>
...
서버 접근 정책은 Policies 메뉴 에서 설정할 수 있습니다. 설정 방법은 [서버 접근 정책 설정하기](policies/setting-server-access-policy)의  **commandsRef**  부분을 참고합니다.

<figure data-layout="center" data-align="center">
![Administrator &gt; Servers &gt; Server Access Control &gt; Command Templates &gt; Create Command Template](/administrator-manual/servers/server-access-control/command-templates/Screenshot-2025-07-22-at-3.23.24-PM.png){width=760 .mx-auto .block}
<figcaption>
