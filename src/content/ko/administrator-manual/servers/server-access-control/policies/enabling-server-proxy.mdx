...
기본적으로 QueryPie 에서 제공하는 웹 Terminal을 통해 서버에 접속할 수 있고, QueryPie 에서 Agent 를 통해 기존의 OS Account/password로 사용하던 툴에서 서버에 접속할 수 있습니다.
...
Proxy 를 통한 서버 접속을 허용하기 위해서는 먼저 Proxy Usage 가 활성화된 Policy 를 생성해야 합니다.
Policy 를 생성하는 방법 및 Proxy Usage 를 활성화하는 방법은 아래 문서를 참조해 주세요.
