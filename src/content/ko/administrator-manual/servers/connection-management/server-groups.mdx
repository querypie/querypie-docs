...
QueryPie에서는 Server Group 단위로 정책을 설정하고 접근 권한을 부여할 수 있습니다.
또한 서버의 Tag를 통해 일괄적으로 서버를 선택하거나, 추후 동기화 되는 서버가 자동으로 서버그룹에 선택되도록 할 수 있습니다.

<figure data-layout="center" data-align="center">
<img src="/administrator-manual/servers/connection-management/server-groups/image-20240902-045633.png" alt="Administrator &gt; Servers &gt; Connection Management &gt; Server Groups" width="760" />
<figcaption>
...
5. 각 행을 클릭하면 서버 그룹 세부 정보 조회할 수 있습니다.
...
3. [서버를 그룹으로 관리하기](server-groups/managing-servers-as-groups) 가이드를 참고하여 서버를 등록합니다.


### Server Group 삭제하기

<figure data-layout="center" data-align="center">
<img src="/administrator-manual/servers/connection-management/server-groups/image-20240728-151520.png" alt="image-20240728-151520.png" width="760" />
</figure>
