...
<Callout type="info">
11.3.0에서 Server group에 추가할 서버 목록 팝업에서 태그를 사용하여 대상을 필터를 할 수 있게 되었습니다.
<figure data-layout="center" data-align="center">
...
<Callout type="info">
Workflow에서 보여지는 Server Group을 제한하기 위해선 Admin &gt; Servers &gt; General &gt; Configurations에서 “Show Server Groups in Workflow if Assigned as Member” 항목을 활성화 해야 합니다.
자세한 위치는 [Server Access Request Default Settings | 기본-서버-접근-정책-설정](../../sac-general-configurations#%ea%b8%b0%eb%b3%b8-%ec%84%9c%eb%b2%84-%ec%a0%91%ea%b7%bc-%ec%a0%95%ec%b1%85-%ec%84%a4%ec%a0%95) 가이드를 참고 부탁드립니다.
</Callout>
