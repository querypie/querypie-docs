...
원장 테이블 정책은 관련 라이선스가 활성화되어 있는 경우에만 사용할 수 있습니다.
해당 기능 사용을 위해서는 QueryPie 고객지원팀으로 문의주세요.
</Callout>
...
승인자 관련 세부 옵션과 실행자 관련 세부 옵션은 [Approval Rules](../../general/workflow-management/approval-rules) 문서를 참고해 주세요.
