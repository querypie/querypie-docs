...
![새로운 BigQuery 커넥션을 생성할 때 Authentication Method 지정](/administrator-manual/databases/connection-management/db-connections/google-bigquery-oauth-authentication-configuration/image-20250116-112226.png){width="760"}
<figcaption>
