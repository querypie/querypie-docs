...
Custom Data Source는 QueryPie에서 기본적으로 지원하지 않는 벤더에 대해 Proxy로 단순 접근제어를 하는 새로운 기능입니다.
단순 접근 제어를 제공함으로써 사용자가 더 다양한 데이터 소스에 안전하게 접근할 수 있도록 합니다.
이 기능은 10.2.6 버전에 추가되었습니다.
...
1.  **DB Access History**
    ...
    * 로그 확인
        ...
        * Connect/Disconnect의 Success/Failure 정보 확인 가능합니다.
            * 접속 허용 시간 외 접속 시도할 경우 모든 벤더에서 동일하게 "This connection is not accessible at this time. Please ask your administrator." 메시지가 표기됩니다.
2.  **Activity Logs**
