...
1.  **DB Connections 메뉴로 이동** 
    ...
    * `+ Create Connection` 버튼을 클릭합니다.
      ...
      ![Screenshot-2025-03-05-at-10.10.11-AM.png](/administrator-manual/databases/connection-management/db-connections/custom-data-source-configuration-and-log-verification/Screenshot-2025-03-05-at-10.10.11-AM.png){width="712"}
      </figure>
2.  **Custom Data Source 생성** 
    *  Custom Data Source 아이콘을 클릭합니다.
      <figure data-layout="center" data-align="center">
      ![Screenshot-2025-03-05-at-10.11.42-AM.png](/administrator-manual/databases/connection-management/db-connections/custom-data-source-configuration-and-log-verification/Screenshot-2025-03-05-at-10.11.42-AM.png){width="712"}
      </figure>
    ...
    * 아래의 연결 정보를 원하는 설정에 맞게 입력합니다. **** 
      <figure data-layout="center" data-align="center">
      ![Screenshot-2025-03-05-at-12.02.22-PM.png](/administrator-manual/databases/connection-management/db-connections/custom-data-source-configuration-and-log-verification/Screenshot-2025-03-05-at-12.02.22-PM.png){width="712"}
      </figure>
...
4.  **Custom Data Source 수정 및 삭제** 
    *  **수정** 
        ...
        * 수정 후 우측 상단의 `Save Changes`버튼을 클릭하여 변경사항을 저장합니다.
          <figure data-layout="center" data-align="center">
          ![Screenshot-2025-03-05-at-6.43.08-PM.png](/administrator-manual/databases/connection-management/db-connections/custom-data-source-configuration-and-log-verification/Screenshot-2025-03-05-at-6.43.08-PM.png){width="760"}
          </figure>
    *  **삭제** 
        ...
        * “Are you sure you want to delete“ 문구가 나온 후 `OK`버튼을 클릭하여 커넥션을 삭제합니다.
          <figure data-layout="center" data-align="center">
          ![Screenshot-2025-03-05-at-6.54.56-PM.png](/administrator-manual/databases/connection-management/db-connections/custom-data-source-configuration-and-log-verification/Screenshot-2025-03-05-at-6.54.56-PM.png){width="688"}
          </figure>
...
2.  **권한 부여** 
    ...
    * 선택 완료 후 `Grant` 버튼을 눌러 권한을 부여합니다. 
      <figure data-layout="center" data-align="center">
      ![Screenshot-2025-03-05-at-1.59.53-PM.png](/administrator-manual/databases/connection-management/db-connections/custom-data-source-configuration-and-log-verification/Screenshot-2025-03-05-at-1.59.53-PM.png){width="712"}
      </figure>
...
1.  **권한 회수** 
    ...
    * 사용자에게 부여된 권한을 중간에 회수하려면 Privilege를 Revoke 합니다.
        ...
        * Detail 페이지에서 권한을 회수하기 위한 커넥션을 선택한 뒤 `Revoke` 버튼을 클릭합니다.
          <figure data-layout="center" data-align="center">
          ![Screenshot-2025-03-05-at-3.18.12-PM.png](/administrator-manual/databases/connection-management/db-connections/custom-data-source-configuration-and-log-verification/Screenshot-2025-03-05-at-3.18.12-PM.png){width="688"}
          </figure>
