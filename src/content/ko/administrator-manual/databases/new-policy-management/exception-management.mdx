...
* **Data Scope** : 정책 예외 대상 테이블 또는 컬럼을 지정합니다. <Badge color="grey">11.1.0</Badge>
    ...
    * Specific data path를 선택하면 직접 대상 테이블 또는 컬럼을 지정할 수 있습니다. <br/>정규식으로 지정할 수도 있습니다. <Badge color="grey">11.3.0</Badge>
