...
*  **Query Annotation**  : 쿼리 수행 시 자동으로 관리자가 지정한 주석을 기록합니다. 기능을 활성화 한 경우 아래 3가지 템플릿을 사용하여 주석을 기록합니다. 10.4.0 기준 Redshift 한정 지원.
...
자세한 설정 방법은 [DB Connections](connection-management/db-connections) 내  **추가 설정하기** 를 참고해주세요.
</Callout>
...
<Callout type="info">
Maximum Policy Exception Period 설정 옵션은 11.3.0 부터 제공됩니다.
</Callout>
