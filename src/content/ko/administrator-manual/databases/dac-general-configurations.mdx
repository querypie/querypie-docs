...
*  **Maximum Policy Exception Period**  : Unmasking 등 정책예외에 대해 최대 유효기간을 설정할 수 있습니다. (시간단위). 이 설정값은 Workflow 신청양식과 New DAC Policy Management 기능 활성화 시 관리자의 수동 정책 설정에 영향을 줍니다. 
    * 기본값 : 720시간 (30일)
    * 최대값 : 8760시간 (1년)
    * 최소값 : 1시간
