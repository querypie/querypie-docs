...
![Administrator &gt; Kubernetes &gt; K8s Access Control &gt; Policies &gt; List Details &gt; Go to Editor Mode](/administrator-manual/kubernetes/k8s-access-control/policies/kubernetes-policy-ui-code-helper-guide/image-20240721-073114.png){width="760"}
<figcaption>
...
1.  **Add Resources**  모달 
  <figure data-layout="center" data-align="center">
  ![image-20240721-073346.png](/administrator-manual/kubernetes/k8s-access-control/policies/kubernetes-policy-ui-code-helper-guide/image-20240721-073346.png){width="426"}
  </figure>
...
2.  **Set Subjects**  모달
  <figure data-layout="center" data-align="center">
  ![image-20240721-073434.png](/administrator-manual/kubernetes/k8s-access-control/policies/kubernetes-policy-ui-code-helper-guide/image-20240721-073434.png){width="424"}
  </figure>
...
3.  **Add Actions**  모달
  <figure data-layout="center" data-align="center">
  ![image-20240721-073515.png](/administrator-manual/kubernetes/k8s-access-control/policies/kubernetes-policy-ui-code-helper-guide/image-20240721-073515.png){width="420"}
  </figure>
    1. Spec: Allow, Spec: Deny 두 곳에서 동일하게 동작합니다.
...
4.  **Set Conditions**  모달
  <figure data-layout="center" data-align="center">
  ![image-20240721-073628.png](/administrator-manual/kubernetes/k8s-access-control/policies/kubernetes-policy-ui-code-helper-guide/image-20240721-073628.png){width="384"}
  </figure>
    1. 해당 항목은 모두 선택사항입니다.
