...
![Administrator &gt; Kubernetes &gt; K8s Access Control &gt; Policies &gt; List Details &gt; Go to Editor Mode](/administrator-manual/kubernetes/k8s-access-control/policies/setting-kubernetes-policies/image-20240721-073114.png){width=760 .mx-auto .block}
<figcaption>
...
4. 이하의 방법을 활용하여 코드 에디터 창에서 원하는 정책 내용을 수정합니다. 
    ...
    2. 하단의 Tips 탭을 통해 각 항목에 대한 정의 방법을 확인하여 코드에 반영합니다. 
        * 참고: [쿠버네티스 정책 Tips 안내](kubernetes-policy-tips-guide)
    3. 우측의 버튼을 통해 코드에 내용을 삽입 또는 수정합니다. 
        * 참고: [쿠버네티스 정책 UI 코드 헬퍼 안내 ](kubernetes-policy-ui-code-helper-guide)
