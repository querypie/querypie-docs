...
* `userAttributes` : 사용자의 attribute을 조건으로 권한 사용을 제한합니다. <Badge color="purple">Value 와일드카드 및 정규표현식 허용</Badge>
* `ipAddresses` : 리소스에 대한 IP 접근 통제 조건 리스트를 단일IP, CIDR 형태로 정의합니다. <Badge color="green">와일드카드 허용</Badge>
</td>
<td>
