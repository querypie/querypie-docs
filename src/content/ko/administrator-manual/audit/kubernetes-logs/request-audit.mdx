...
![image-20240721-082824.png](/administrator-manual/audit/kubernetes-logs/request-audit/image-20240721-082824.png){width=760 .mx-auto .block}
</figure>
...
4. 검색 필드 우측 필터 버튼을 클릭하여 AND/OR 조건으로 이하의 필터링이 가능합니다.
  <figure data-layout="center" data-align="center">
  ![image-20240721-082906.png](/administrator-manual/audit/kubernetes-logs/request-audit/image-20240721-082906.png){width=736 .mx-auto .block}
  </figure>
...
1. 각 행을 클릭하면 세부 정보 조회가 가능합니다. <br/> 
  <figure data-layout="center" data-align="center">
  ![image-20250116-121412.png](/administrator-manual/audit/kubernetes-logs/request-audit/image-20250116-121412.png){width=736 .mx-auto .block}
  </figure>
    1. 최상단에는 기본 이벤트에 따른 정보를 노출합니다:
        ...
        13.  **Pod Session Recording**  : Pod exec API로 실행 시 해당 세션에 대한 레코딩
            ...
            2. Pod exec API로 실행 시 해당 세션에 대한 레코딩이 진행되며, 해당 “Session Recording” 문구에 하이퍼링크가 포함됩니다. 
              <figure data-layout="center" data-align="center">
              ![image-20240512-055657.png](/administrator-manual/audit/kubernetes-logs/request-audit/image-20240512-055657.png){width=218 .mx-auto .block}
              </figure>
            3. 링크 클릭 시 관련 세션 레코딩이 플레이됩니다. 
              <figure data-layout="center" data-align="center">
              ![image-20240721-082651.png](/administrator-manual/audit/kubernetes-logs/request-audit/image-20240721-082651.png){width=382 .mx-auto .block}
              </figure>
