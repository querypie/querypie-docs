...
쿼리파이 공통으로 제공되는 감사 로그에 더하여 쿼리파이 쿠버네티스 접근제어 (QueryPie KAC) 라이선스 보유 시, 이하의 감사 로그의 종류를 제공합니다.
...
* [Request Audit](kubernetes-logs/request-audit) : 쿠버네티스 API 서버 호출 내역
* [Pod Session Recordings](kubernetes-logs/pod-session-recordings) : Pod Exec 등의 연결 세션 내 행위 녹화 내역
* [Kubernetes Role History](kubernetes-logs/kubernetes-role-history) : 쿠버네티스 접근 권한 부여 및 회수 이력
