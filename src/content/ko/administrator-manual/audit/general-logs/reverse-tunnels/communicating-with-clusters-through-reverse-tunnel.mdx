...
QueryPie와 다른 Network Zone에 있는 리소스와 통신을 하는 수단으로 Reverse Tunneling을 지원하고 있습니다.
통신하려는 Network Zone에 Reverse Tunnel Agent를 설치하면 Reverse Tunnel Agent에서 QueryPie 방향(Outbound)으로 연결을 맺습니다.
