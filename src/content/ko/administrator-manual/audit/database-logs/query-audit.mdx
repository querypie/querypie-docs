...
![Administrator &gt; Audit &gt; Databases &gt; Query Audit](/administrator-manual/audit/database-logs/query-audit/image-20240730-090702.png){width=640 .mx-auto .block}
<figcaption>
...
4. 검색 필드 우측 필터 버튼을 클릭하여 AND/OR 조건으로 이하의 필터링이 가능합니다.
  <figure data-layout="center" data-align="center">
  ![image-20240730-091338.png](/administrator-manual/audit/database-logs/query-audit/image-20240730-091338.png){width=616 .mx-auto .block}
  </figure>
...
<figure data-layout="center" data-align="center">
![Administrator &gt; Audit &gt; Databases &gt; Query Audit &gt; Query Audit Details](/administrator-manual/audit/database-logs/query-audit/image-20240730-091103.png){width=640 .mx-auto .block}
<figcaption>
...
* 하단에는 실행 쿼리 본문 및 추가 내역을 노출합니다:
    ...
    2.  **First 10 Rows**  : 호출된 SELECT문에 대한 첫 열 행 샘플
        * 해당 필드는  **Display the first 10 rows in Query Audit**  설정을 활성화한 경우에만 표기됩니다. (Default : Off)
            * [Security](../../general/company-management/security) 내  **DB 커넥션 보안 설정**  참고
