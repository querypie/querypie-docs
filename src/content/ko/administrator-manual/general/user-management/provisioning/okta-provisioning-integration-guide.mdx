...
<Callout type="info">
이 가이드는 Okta의 App Integration Wizard(AIW)를 기반으로 QueryPie와 SCIM 연동을 구현하는 방법을 안내합니다.
이 제품의 SCIM 기능은 RFC 7643을 기반하여 SCIM 2.0 기본 규격에 맞추어 제작되었으므로, 타사 Identity Provider 연동 시에도 이 가이드를 따라 필요한 정보를 QueryPie에서 수집하여 연동을 진행하기 바랍니다.
</Callout>
...
<Callout type="info">
Okta API를 활용한 아웃바운드 사용자 동기화를 설정할 예정인 경우, [Okta 연동하기](../authentication/integrating-with-okta) 페이지 내 절차대로 대신 진행하기 바랍니다. SCIM과 동시에 활성화 시, 사용자 동기화에 영향을 받을 수 있으므로 유의하기 바랍니다.
</Callout>
...
<img src="/administrator-manual/general/user-management/provisioning/okta-provisioning-integration-guide/image-20240723-050205.png" alt="Okta Admin Console &gt; Applications &gt; Applications &gt; Create App Integration &gt; SAML 2.0 &gt; Configure SAML" width="760" />
<figcaption>
...
6. General Settings 단계에서 General Settings 내 값을 적절히 정의한 뒤 하단의 `Next` 버튼을 클릭합니다.
    ...
    2.  **App logo**  : 사용자가 식별 가능한 로고를 업로드합니다.
...
11. [Okta 연동하기 | Okta에서-QueryPie-애플리케이션-연동-정보-설정](../authentication/integrating-with-okta#okta%ec%97%90%ec%84%9c-querypie-%ec%95%a0%ed%94%8c%eb%a6%ac%ec%bc%80%ec%9d%b4%ec%85%98-%ec%97%b0%eb%8f%99-%ec%a0%95%eb%b3%b4-%ec%84%a4%ec%a0%95) 및 [Okta 연동하기 | QueryPie에서-Okta-연동-및-동기화-설정](../authentication/integrating-with-okta#querypie%ec%97%90%ec%84%9c-okta-%ec%97%b0%eb%8f%99-%eb%b0%8f-%eb%8f%99%ea%b8%b0%ed%99%94-%ec%84%a4%ec%a0%95)을 따라 SSO 연동을 마무리한 뒤, 이후 스텝을 진행하기 바랍니다.
...
<figure data-layout="center" data-align="center">
<img src="/administrator-manual/general/user-management/provisioning/okta-provisioning-integration-guide/image-20240723-054522.png" alt="Okta Admin Console &gt; Applications &gt; Applications &gt; Custom SCIM App &gt; Provisioning &gt; Integration" width="760" />
<figcaption>
...
2. SCIM Connection의 우측 `Edit` 버튼을 눌러 이하의 값을 채워 수정합니다.
    ...
    3. Supported provisioning action : 다음의 다섯 항목을 모두 선택합니다.
    ...
    5. HTTP Header &gt; Authorization : QueryPie에서 생성한 SCIM 전용 access token 값을 삽입합니다.
3. Test Connector Configuration 버튼을 눌러 연결 테스트를 진행합니다. 
4. “ *Connector configured successfully* ” 문구와 함께 팝업이 나타나면 `Close` 버튼을 클릭합니다. 
  <figure data-layout="center" data-align="center">
  <img src="/administrator-manual/general/user-management/provisioning/okta-provisioning-integration-guide/image-20240430-025059.png" alt="image-20240430-025059.png" width="324" />
  </figure>
...
<figure data-layout="center" data-align="center">
<img src="/administrator-manual/general/user-management/provisioning/okta-provisioning-integration-guide/image-20240430-034915.png" alt="Okta Admin Console &gt; Applications &gt; Applications &gt; Custom SCIM App &gt; Provisioning &gt; To App" width="760" />
<figcaption>
...
#### 일부 Attribute를 추가적으로 동기화하는 방법

<Callout type="important">
QueryPie Profile의 속성 가운데, staticIp, macAddress 등 일부 attribute 항목은 SCIM Integration의 기본 설정에서는 Import 되지 않습니다.
</Callout>

쿼리파이 프로필 내 staticIp, macAddress 등 일부 attribute 항목이 SCIM Integration 당시에 별도 import 되지 않습니다.
해당 Attribute는 아래와 같습니다:
...
해당 Attribute 정보를 함께 동기화해야 하는 경우, Okta 등의 IdP에서 Custom Attribute를 추가하여 매핑하여 동기화할 수 있습니다.

##### [Okta에서 Custom Attribute를 설정하는 예시]

1. SCIM 앱의 Provisioning 탭 &gt; To App 하단의 `Go to Profile Editor`를 클릭합니다.
  <figure data-layout="center" data-align="center">
  <img src="/administrator-manual/general/user-management/provisioning/okta-provisioning-integration-guide/image-20240712-082412.png" alt="image-20240712-082412.png" width="518" />
  </figure>
2. `Add Attribute` 버튼을 클릭합니다. 
  <figure data-layout="center" data-align="center">
  <img src="/administrator-manual/general/user-management/provisioning/okta-provisioning-integration-guide/image-20240712-082549.png" alt="image-20240712-082549.png" width="187" />
  </figure>
3. 동기화에 필요한 Attribute를 새로 등록합니다. 
  <figure data-layout="center" data-align="center">
  <img src="/administrator-manual/general/user-management/provisioning/okta-provisioning-integration-guide/image-20240712-082453.png" alt="image-20240712-082453.png" width="314" />
  </figure>
    ...
    3. Variable name & External name : 동기화할 custom attribute 변수명을 기입합니다. 
        * 쿼리파이 사용자 프로필에서도 괄호로 변수명 확인이 가능합니다. 
          <figure data-layout="center" data-align="center">
          <img src="/administrator-manual/general/user-management/provisioning/okta-provisioning-integration-guide/image-20240712-083117.png" alt="image-20240712-083117.png" width="144" />
          </figure>
    4. External namespace : 아래 값을 기입합니다.<br/>`urn:ietf:params:scim:schemas:extension:querypie:2.0:User`
    5. 이후 `Save` 또는 `Save and Add Another` 버튼을 클릭하여 저장합니다.
4. 그 다음 `Mappings` 버튼을 클릭합니다. 
  <figure data-layout="center" data-align="center">
  <img src="/administrator-manual/general/user-management/provisioning/okta-provisioning-integration-guide/image-20240712-082549.png" alt="image-20240712-082549.png" width="187" />
  </figure>
    1. 프롬프트 상단의 탭을 2번째 탭(Okta → `{APP}`)으로 선택합니다. 
      <figure data-layout="center" data-align="center">
      <img src="/administrator-manual/general/user-management/provisioning/okta-provisioning-integration-guide/image-20240712-083618.png" alt="image-20240712-083618.png" width="285" />
      </figure>
    2. 하단에 새로 생성한 Custom Attribute와 IdP 내 적절한 Attribute를 매핑하고 Save Mappings 버튼을 클릭하여 설정을 저장합니다. 
      <figure data-layout="center" data-align="center">
      <img src="/administrator-manual/general/user-management/provisioning/okta-provisioning-integration-guide/image-20240712-085207.png" alt="image-20240712-085207.png" width="450" />
      </figure>
5. 이후 사용자를 앱에 할당합니다.
...
1. SCIM 앱으로 다시 돌아가서 Assignments 탭에서 `Assign` 버튼의 옵션을 통해 사용자를 할당합니다. 
  <figure data-layout="center" data-align="center">
  <img src="/administrator-manual/general/user-management/provisioning/okta-provisioning-integration-guide/image-20240430-035937.png" alt="Okta Admin Console &gt; Applications &gt; Applications &gt; Custom SCIM App &gt; Assignments" width="736" />
  <figcaption>
...
2. QueryPie 앱으로 돌아가서 Administrator &gt; General &gt; User Management &gt; Users로 이동하여 사용자가 정상 푸시되었는지 확인합니다. 
  <figure data-layout="center" data-align="center">
  <img src="/administrator-manual/general/user-management/provisioning/okta-provisioning-integration-guide/image-20240723-040531.png" alt="Administrator &gt; General &gt; User Management &gt; Users &gt; List Details" width="736" />
  <figcaption>
...
<figure data-layout="center" data-align="center">
<img src="/administrator-manual/general/user-management/provisioning/okta-provisioning-integration-guide/image-20240430-062231.png" alt="Okta Admin Console &gt; Applications &gt; Applications &gt; Custom SCIM App &gt; Push Groups" width="760" />
<figcaption>
...
<Callout type="important">
Okta 등 타사 Identity Provider(IdP)에서 푸시하여 생성한 Auth Provider가 QueryPie가 아닌 그룹의 경우, 그룹의 삭제를 해당 IdP에서 unlink 후 삭제 처리하시는 것을 권장드립니다.
이 제품에서 그룹을 삭제할 경우, 해당 IdP에서의 관리 플로우가 엉켜 해당 삭제된 그룹명으로는 제품에 다시 push가 어려울 수 있습니다.
</Callout>
