...
현재 QueryPie에서 지원하는 IdP 서비스는 다음과 같습니다.
...
* 계정 시스템 내에 신규 입사자가 발생하는 경우, 동기화하면 QueryPie 사용자로 추가됩니다.
* 계정 시스템 내에 퇴사자가 발생하는 경우, 동기화하면 QueryPie 사용자에서 삭제됩니다.
...
* 단, Username과 Email 항목은 고유 값으로 중복하여 등록할 수 없습니다.
