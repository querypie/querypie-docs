...
![Administrator &gt; General &gt; Workflow Management &gt; Approval Rules &gt; Workflow Configurations](/administrator-manual/general/workflow-management/workflow-configurations/screenshot-20250310-110949.png){width="760"}
<figcaption>
...
* DB Access Request : DB Connection에 부여된 태그를 목록에서 볼 수 있고 필터를 통해 특정 태그가 있는 커넥션만 필터링 할 수 있습니다.
  <figure data-layout="center" data-align="center">
  ![DB Access Reqeust 양식에서 태그 표시 및 필터링](/administrator-manual/general/workflow-management/workflow-configurations/image-20250629-180040.png){width="736"}
  <figcaption>
