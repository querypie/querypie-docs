...
Tag Display and Filtering in DAC Workflow Requests 토글 스위치로 활성화합니다.

이 옵션을 활성화하는 경우, 아래의 요청 양식에서 태그로 대상을 필터링할 수 있습니다.

* DB Access Request : DB Connection에 부여된 태그를 목록에서 볼 수 있고 필터를 통해 특정 태그가 있는 커넥션만 필터링할 수 있습니다.
  <figure data-layout="center" data-align="center">
  <img src="/administrator-manual/general/workflow-management/workflow-configurations/image-20250629-180040.png" alt="DB Access Reqeust 양식에서 태그 표시 및 필터링" width="736" />
  <figcaption>
