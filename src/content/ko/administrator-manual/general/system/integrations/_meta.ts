export default {
  'integrating-with-syslog': 'Syslog 연동',
  'integrating-with-splunk': 'Splunk 연동',
  'integrating-with-secret-store': 'Secret Store 연동',
  'integrating-with-email': 'Email 연동',
  ...
  'llm-provider-configuration': 'LLM Provider 설정',
};
