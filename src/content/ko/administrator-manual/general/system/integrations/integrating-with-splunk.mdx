...
![Splunk 연계 권장 아키텍쳐](/administrator-manual/general/system/integrations/integrating-with-splunk/screenshot-20240613-174947.png){width="760"}
<figcaption>
Splunk 연계 권장 아키텍쳐
</figcaption>
</figure>
...
<figure data-layout="center" data-align="center">
![(좌) TCP / UDP 설정 화면 (우) HTTP / HTTPS 설정 화면](/administrator-manual/general/system/integrations/integrating-with-splunk/image-20240523-101104.png){width="760"}
<figcaption>
