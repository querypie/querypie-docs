...
<img src="/administrator-manual/general/system/integrations/integrating-with-splunk/screenshot-20240613-174947.png" alt="Splunk 연계 권장 아키텍처" width="760" />
<figcaption>
Splunk 연계 권장 아키텍처
</figcaption>
</figure>
...
이전에 Syslog (Legacy)에서만 Timezone 설정을 할 수 있었으나 SIEM 관련 설정 모두(Syslog, Splunk) Timezone 설정을 할 수 있도록 변경되었습니다.
또한 New DAC Policy Management 기능에 의해 발생된 이벤트에 대한 스트리밍 전송 기능이 추가되었습니다.
