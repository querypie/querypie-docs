...
* 각 Alert Type별로 Alert의 자세한 정보를 반환하는 **Detail API가 추가**되었습니다.
</td>
</tr>
<tr>
<th>
...
<td>
* **하나의 API**로 모든 Type의 Alert를 생성 가능 <br/>→ 각 Alert Type별로 **생성 API가 분리**되었습니다.
...
<td>
* **하나의 API**로 모든 Type의 Alert를 수정 가능 <br/>→ 각 Alert Type별로 **수정 API를 분리**했습니다.
...
* **dbUserInfo** 가 **삭제**되었습니다. **userMultipleAccount** 가 **삭제**되었습니다.
    * 이 필드의 내용은 connectionAccount를 통해 전달됩니다.<br/>
