...
* **Approval Expiration Date**: 승인 만료일을 입력합니다. Maximum Approval Duration을 통해 최대값을 설정할 수 있습니다. Approval Expiration Date은 Data Access Expiration End Date을 초과할 수 없습니다. 초과한 경우, 상신할 수 없습니다.
...
* **Policy Exception Schedule** : Data Access 정책 예외가 적용되는 기간을 설정하여 요청할 수 있습니다. 최대 정책 예외의 유효 기간은 관리자가 설정한 최대 기간(Maximum Policy Exception Period)을 넘겨서 신청할 수 없습니다.
