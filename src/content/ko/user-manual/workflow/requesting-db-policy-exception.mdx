...
![Screenshot-2025-08-26-at-12.54.02-AM.png](/user-manual/workflow/requesting-db-policy-exception/Screenshot-2025-08-26-at-12.54.02-AM.png){width=760 .mx-auto .block}
</figure>
...
<figure data-layout="center" data-align="center">
![screenshot-20240724-154729.png](/user-manual/workflow/requesting-db-policy-exception/screenshot-20240724-154729.png){width=763 .mx-auto .block}
</figure>
...
<figure data-layout="center" data-align="center">
![screenshot-20240724-171350.png](/user-manual/workflow/requesting-db-policy-exception/screenshot-20240724-171350.png){width=760 .mx-auto .block}
</figure>
...
<figure data-layout="center" data-align="center">
![screenshot-20240523-184245.png](/user-manual/workflow/requesting-db-policy-exception/screenshot-20240523-184245.png){width=760 .mx-auto .block}
</figure>
...
*  **Data Access Expiration**  : 요청할 데이터 접근 허용 기간을 설정할 수 있습니다.
    ...
    2. End Date 선택시, 일자와 시간을 기준으로 선택 가능하며, 최소는 현재 시간, 최대는 180일로 요청할 수 있습니다.
*  **Reason for Request**  : 정책 예외 신청 사유를 입력합니다. 최대 1000자까지 입력할 수 있습니다.
* 페이지 하단의 `Submit` 버튼을 눌러 요청을 상신합니다.<br/>
  <figure data-layout="center" data-align="center">
  ![User &gt; Workflow &gt; Submit Request &gt; DB Policy Exception Request](/user-manual/workflow/requesting-db-policy-exception/image-20250629-124654.png){width=664 .mx-auto .block}
  <figcaption>
