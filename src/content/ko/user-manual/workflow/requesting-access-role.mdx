...
* **Approval Expiration Date**: 승인 만료일을 입력합니다. Maximum Approval Duration을 통해 최대값을 설정할 수 있습니다. Approval Expiration Date은 Role Expiration Date을 초과할 수 없습니다. 초과한 경우, 상신할 수 없습니다.
...
4. **Role Expiration Date** : 해당 권한이 회수되는 만료 일자를 선택합니다.
