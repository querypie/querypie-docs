...
QueryPie 설치 후 필수적으로 수행해야 하는 초기 설정을 안내합니다.

## 설정 체크리스트

| 순서 | 설정 항목 | 필수 여부 |
| --- | --- | --- |
| 1 | Web Base URL 설정 | 필수 |
| 2 | DAC/SAC Proxy 주소 설정 | DAC/SAC 사용 시 |
| 3 | KAC Proxy 주소 설정 | KAC 사용 시 |
| 4 | WAC Proxy 주소 설정 | WAC 사용 시 |

## 공통 설정

모든 환경에서 필수로 설정해야 하는 항목입니다.
...
사용하는 기능에 따라 Proxy 접속 주소를 설정합니다.
