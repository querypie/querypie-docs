...
QUERYPIE_WEB_URL은 서비스 접근, 인증 연동, 데이터 다운로드, 외부 연동 및 Proxy 설정 등 다양한 경로에서 사용되므로 필수로 설정해야 합니다.

<Callout type="important">
**QueryPie 버전 10.2.8부터 이 환경변수는 사용되지 않습니다. General 메뉴의 Web Base URL로 대체됩니다.**
...
* OAuth 인증 연동 시 Issuer URL 생성 및 발급된 토큰의 issuer 검증에 사용되는 URL
