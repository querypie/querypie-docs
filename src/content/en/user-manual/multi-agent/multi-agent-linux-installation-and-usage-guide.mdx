...
Multi Agent provides a tray icon feature through [StatusNotifierItem](https://www.freedesktop.org/wiki/Specifications/StatusNotifierItem/).

Depending on the Linux distribution, StatusNotifierItem may not be displayed by default.
