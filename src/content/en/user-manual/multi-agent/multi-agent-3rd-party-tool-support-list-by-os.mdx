...
In addition to the tools supported via agentless connections, you can also connect to databases or servers.
...
With Seamless SSH configuration, other tools can also securely connect to servers through QueryPie.
