...
# Requesting Access Role Request

### Overview

Access Role Request allows you to easily request roles for servers or Kubernetes clusters that need access.
Roles are granted immediately upon approval, and you can access servers or Kubernetes clusters allowed by the role.
...
4. **Role Expiration Date**: Select the expiration date when the permission will be revoked.
