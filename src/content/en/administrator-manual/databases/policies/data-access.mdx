...
<figure data-layout="center" data-align="center">
<img src="/administrator-manual/databases/policies/data-access/data-access-03.png" alt="SQL Editor &gt; Displayed as *`{RESTRICTED}`* when querying data with applied policies" />
<figcaption>
...
When selecting Database Name, "[ENGINE] [30101] Please Check the user credential or IP ACL settings.
Access denied for user 'username'@'host' (using password: YES)" error occurs.
...
<figure data-layout="center" data-align="center">
<img src="/administrator-manual/databases/policies/data-access/image-20250512-040339.png" alt="Checking logs in Logs tab" width="736" />
<figcaption>
...
4. Click on rows in the Log tab to check the executed query in the detail screen.
  <figure data-layout="center" data-align="center">
  <img src="/administrator-manual/databases/policies/data-access/image-20250512-040436.png" alt="Checking query content in detailed log view" width="736" />
  <figcaption>
