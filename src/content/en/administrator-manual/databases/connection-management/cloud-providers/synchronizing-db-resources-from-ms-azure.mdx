...
8.  **Database Type Filter**  Select the resources you want to synchronize.
    * Currently, only Azure SQL Database can be synchronized.
9.  **Search Filter**  You can get a list of specific types of resources you want to synchronize.
...
10.  **Replication**   **Frequency**  Select the synchronization method.
