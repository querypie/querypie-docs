...
5. After confirming the four attributes have been added, click the `Mappings` button.
6. Map Okta User Profile attributes to QueryPie User Profile attributes as follows:
...
7. Click the `Save Mappings` button to save.
