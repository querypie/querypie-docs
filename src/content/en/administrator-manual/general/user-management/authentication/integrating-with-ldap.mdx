...
`Add Row` Click the button in the top right corner to add a new mapping row, and you can specify QueryPie Attributes corresponding to LDAP Attributes for each row.
...
1. You can check synchronized users and groups in Administrator &gt; General &gt; User Management &gt; Users or Groups menu.
