...
1. In the Roles list, click on the administrator role you want to assign additional policies to enter the detail page. `Assign Policies` Click the button to open the modal.
...
Enter the detail page of the administrator role you want to remove policies from in the Roles list. Select the policy you want to remove with a checkbox in the policy list in the Detail tab, then click the `Delete` button. `OK` Click the button in the confirmation modal to complete policy removal.
...
Enter the detail page of the administrator role you want to modify in the Roles list. `Edit` Click the button to open the modification modal, where you can modify the name and description.
...
Enter the detail page of the administrator role you want to delete in the Roles list. `Delete` Click the button to open the deletion confirmation modal, then correctly enter the deletion confirmation phrase "DELETE" and click the `Delete` button to complete administrator role deletion.
