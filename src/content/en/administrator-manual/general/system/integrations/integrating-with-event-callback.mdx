...
1. Enter the following information to configure the Event Callback.
    ...
    * Description: Enter a description for this configuration (optional).<br/>
      <figure data-layout="center" data-align="center">
      ![Event Callback settings popup dialog](/administrator-manual/general/system/integrations/integrating-with-event-callback/Screenshot-2025-08-25-at-6.06.50-PM.png)
      <figcaption>
