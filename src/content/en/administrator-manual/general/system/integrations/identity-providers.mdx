...
* Starting from 11.5.0, when using Internal DB with LDAP or Internal DB with Custom Identity Provider, you can use MFA in each respective setting.<br/>For example, if MFA is set in LDAP and MFA is set in Internal DB, user accounts that are LDAP accounts are controlled by LDAP's MFA settings, and user accounts in Internal DB are controlled by Internal DB's MFA settings.
...
<img src="/administrator-manual/general/system/integrations/identity-providers/image-20251014-010700.png" alt="image-20251014-010700.png" width="760" />
</figure>
...
<figure data-layout="center" data-align="center">
<img src="/administrator-manual/general/system/integrations/identity-providers/image-20251014-011706.png" alt="Internal database details" width="532" />
<figcaption>
...
<figure data-layout="center" data-align="center">
<img src="/administrator-manual/general/system/integrations/identity-providers/image-20251014-012049.png" alt="LDAP details" width="481" />
<figcaption>
LDAP details
</figcaption>
</figure>
...
<figure data-layout="center" data-align="center">
<img src="/administrator-manual/general/system/integrations/identity-providers/image-20251014-075227.png" alt="image-20251014-075227.png" width="407" />
</figure>
...
<figure data-layout="center" data-align="center">
<img src="/administrator-manual/general/system/integrations/identity-providers/image-20251014-075127.png" alt="image-20251014-075127.png" width="408" />
</figure>
...
<Callout type="important">
When integrating Active Directory with LDAP, you must set the Anonymous option to false.
AD does not allow search operations in an anonymous bind state by default.
<figure data-layout="center" data-align="center">
<img src="/administrator-manual/general/system/integrations/identity-providers/image-20251222-023912.png" alt="image-20251222-023912.png" width="491" />
</figure>
</Callout>
...
<figure data-layout="center" data-align="center">
<img src="/administrator-manual/general/system/integrations/identity-providers/image-20240723-064242.png" alt="Okta Admin &gt; Applications &gt; Applications &gt; Browse App Catalog &gt; Search for QueryPie" width="760" />
<figcaption>
...
<figure data-layout="center" data-align="center">
<img src="/administrator-manual/general/system/integrations/identity-providers/image-20240723-064424.png" alt="Okta Admin &gt; Directory &gt; Profile Editor &gt; QueryPie User &gt; Add Attribute" width="760" />
<figcaption>
...
<figure data-layout="center" data-align="center">
<img src="/administrator-manual/general/system/integrations/identity-providers/image-20240723-064721.png" alt="Okta Admin &gt; Directory &gt; Profile Editor &gt; QueryPie User &gt; Mappings" width="760" />
<figcaption>
...
<figure data-layout="center" data-align="center">
<img src="/administrator-manual/general/system/integrations/identity-providers/image-20240723-065134.png" alt="Okta Admin &gt; Applications &gt; Applications &gt; QueryPie App" width="760" />
<figcaption>
...
* Assign the user(s) or group(s) to allow QueryPie access with Okta accounts, then click the Done button.
    * For People assignment, review the user information and click the `Save and Go Back` button.
...
<figure data-layout="center" data-align="center">
<img src="/administrator-manual/general/system/integrations/identity-providers/image-20240723-065346.png" alt="Okta Admin &gt; Applications &gt; Applications &gt; QueryPie App" width="760" />
<figcaption>
Okta Admin &gt; Applications &gt; Applications &gt; QueryPie App
</figcaption>
</figure>
...
<figure data-layout="center" data-align="center">
<img src="/administrator-manual/general/system/integrations/identity-providers/image-20240110-042233.png" alt="Okta Admin Console &gt; Security &gt; Administrators &gt; Roles &gt; Create new role" width="762" />
<figcaption>
...
* Define Role name (e.g., MinimumAdminRole) and Role description, then check only the following permissions in Select Permissions:
    *  **User**
...
* Then, sign back in with the original administrator account you worked with initially, go to Security &gt; Administrators &gt; Admins tab, edit the integration account, and revoke the Read-Only Administrator permission.
...
<figure data-layout="center" data-align="center">
<img src="/administrator-manual/general/system/integrations/identity-providers/image-20251014-014729.png" alt="Okta details (1)" width="481" />
<figcaption>
Okta details (1)
</figcaption>
</figure>
...
*  **Name**  : Enter a suitable name for the IdP for easy identification.
*  **Type** : Select Okta.
*  **Identity Provider Metadata**  : <br/>Paste the XML information copied in the [Configure QueryPie application integration settings in Okta](#configure-querypie-application-integration-settings-in-okta) section into the Identity Provider Metadata field.
...
<figure data-layout="center" data-align="center">
<img src="/administrator-manual/general/system/integrations/identity-providers/screenshot-20250124-164255.png" alt="Audience URI (SP Entity ID) in Okta app settings" width="690" />
<figcaption>
...
<figure data-layout="center" data-align="center">
<img src="/administrator-manual/general/system/integrations/identity-providers/screenshot-20250124-164553.png" alt="Index for Other Requestable SSO URLs" width="694" />
<figcaption>
...
<figure data-layout="center" data-align="center">
<img src="/administrator-manual/general/system/integrations/identity-providers/image-20251014-014805.png" alt="Okta details (2)" width="481" />
<figcaption>
Okta details (2)
</figcaption>
</figure>
...
<figure data-layout="center" data-align="center">
<img src="/administrator-manual/general/system/integrations/identity-providers/Authentication-Okta-02.png" alt="Top URL of Okta Admin &gt; Applications &gt; QueryPie App" width="760" />
<figcaption>
...
<figure data-layout="center" data-align="center">
<img src="/administrator-manual/general/system/integrations/identity-providers/image-20251014-082704.png" alt="image-20251014-082704.png" width="760" />
</figure>
...
<figure data-layout="center" data-align="center">
<img src="/administrator-manual/general/system/integrations/identity-providers/image-20251020-001435.png" alt="One Login details (1)" width="480" />
<figcaption>
One Login details (1)
</figcaption>
</figure>
...
<figure data-layout="center" data-align="center">
<img src="/administrator-manual/general/system/integrations/identity-providers/image-20251014-014949.png" alt="One Login details (2)" width="481" />
<figcaption>
One Login details (2)
</figcaption>
</figure>
...
*  **Name**  : Enter a suitable name for the IdP for easy identification.
*  **Type** : Select SAML.
*  **Identity Provider Metadata**  : Copy and paste the contents of the SAML metadata XML confirmed in the IdP.

<figure data-layout="center" data-align="center">
<img src="/administrator-manual/general/system/integrations/identity-providers/image-20251014-015015.png" alt="image-20251014-015015.png" width="481" />
</figure>
