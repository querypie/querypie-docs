...
* For more detailed Vault configuration, please refer to the [Hashicorp Vault Documentation official documentation](https://developer.hashicorp.com/vault/docs) for reference.
</Callout>
...
2. `OK` Click the button in the deletion confirmation modal.
...
1. `Connect` Click the button on the HashiCorp Vault page.
...
1. `+ Connect` Click the button on the Active Directory page.
