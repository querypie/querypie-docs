...
<img src="/administrator-manual/general/system/integrations/integrating-with-splunk/screenshot-20240613-174947.png" alt="Recommended Splunk Integration Architecture" width="760" />
<figcaption>
...
<figure data-layout="center" data-align="center">
<img src="/administrator-manual/general/system/integrations/integrating-with-splunk/image-20240523-101104.png" alt="(Left) TCP / UDP Settings Screen (Right) HTTP / HTTPS Settings Screen" width="760" />
<figcaption>
...
6. To start transmission, switch the toggle button in the top left of the page to `ON`.
...
7. If syslog transmission is no longer needed, you can remove the configuration through the `Delete` button.
...
Previously, Timezone settings were only available in Syslog (Legacy), but now Timezone settings are available for all SIEM-related settings (Syslog, Splunk).
...
<figure data-layout="center" data-align="center">
<img src="/administrator-manual/general/system/integrations/integrating-with-splunk/image-20251009-045210.png" alt="image-20251009-045210.png" width="760" />
</figure>
