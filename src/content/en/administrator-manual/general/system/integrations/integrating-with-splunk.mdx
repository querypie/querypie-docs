...
3. `Configure` Click the button on the detail page to display a popup where you can enter Destination information.
...
2. `OK` Click the button to save the settings.
