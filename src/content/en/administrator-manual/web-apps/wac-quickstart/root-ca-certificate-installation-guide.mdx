...
3. Double-click the querypie certificate to open the modal, click the Trust item to expand the collapsed area, then change **When using this certificate** : `Use system defaults` to `Always trust` and close the modal.
  ...
  <img src="/administrator-manual/web-apps/wac-quickstart/root-ca-certificate-installation-guide/screenshot-20250113-201320.png" alt="screenshot-20250113-201320.png" width="600" />
  </figure>
...
5. The newly installed querypie certificate is displayed as trusted for all users.
  <figure data-layout="center" data-align="center">
  <img src="/administrator-manual/web-apps/wac-quickstart/root-ca-certificate-installation-guide/screenshot-20250113-201143.png" alt="screenshot-20250113-201143.png" width="600" />
  </figure>
...
3. When the Certificate Import Wizard window opens, select `Current User(C)` for the storage location and click the `Next(N)` button.
  <figure data-layout="center" data-align="center">
  <img src="/administrator-manual/web-apps/wac-quickstart/root-ca-certificate-installation-guide/screenshot-20250113-202645.png" alt="screenshot-20250113-202645.png" width="450" />
  </figure>
...
5. When the **Select Certificate Store** modal opens, select Trusted Root Certification Authorities. Keep the actual store display option unchecked. Click the OK button.
  <figure data-layout="center" data-align="center">
  <img src="/administrator-manual/web-apps/wac-quickstart/root-ca-certificate-installation-guide/screenshot-20250113-202727.png" alt="screenshot-20250113-202727.png" width="456" />
  </figure>
6. Confirm the certificate store settings and click the `Next(N)` button.
  <figure data-layout="center" data-align="center">
  <img src="/administrator-manual/web-apps/wac-quickstart/root-ca-certificate-installation-guide/screenshot-20250113-202738.png" alt="screenshot-20250113-202738.png" width="456" />
  </figure>
7. Confirm the set content and click the `Finish(F)` button.
  <figure data-layout="center" data-align="center">
  <img src="/administrator-manual/web-apps/wac-quickstart/root-ca-certificate-installation-guide/screenshot-20250113-203130.png" alt="screenshot-20250113-203130.png" width="458" />
  </figure>
8. A security warning modal appears. Click the `Yes(Y)` button to immediately execute certificate import. Click the OK button in the import completion modal.
  <figure data-layout="center" data-align="center">
  <img src="/administrator-manual/web-apps/wac-quickstart/root-ca-certificate-installation-guide/screenshot-20250113-203453.png" alt="screenshot-20250113-203453.png" width="407" />
  </figure>
...
### 4. Certificate Compatibility Notes

Please refer to the following algorithm requirements when installing a Root CA certificate:

* RSA and ECDSA (e.g., P-256, P-384) based certificates can be installed and trusted on most operating systems and browsers without issues.
* Ed25519 based certificates are cryptographically valid, but may not be supported as a Root CA in macOS Keychain and Windows trust stores.
* Due to this limitation, adding or trusting Ed25519 certificates in OS certificate stores may fail. We recommend using RSA or ECDSA certificates for Root CA purposes.
