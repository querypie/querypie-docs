...
3. Click the `Dry run` button in the top right to check in advance which servers will be synchronized from Azure. Dry run results are not saved.
...
* Register a new application in the 'App registrations' menu in the left menu. 
    * **Enter the ID value of the application as Client Secret ID.** 
* Move to the 'Certificates & secrets menu' in the detailed page of the registered application.
* Click the 'New client secret' button at the top to create a new client secret.
* Access the 'IAM' menu of 'Subscriptions'. 
* Assign the previously registered application to the 'Reader' role through role assignment addition. 
</Callout>
