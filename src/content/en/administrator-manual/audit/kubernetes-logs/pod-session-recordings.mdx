...
7. Click the Action At link in each row to play the session recording history.
8. Clicking the Action At link executes a modal and displays a modal showing the initial download process for playback.
  <figure data-layout="center" data-align="center">
...
9. Depending on whether the recorded file size exceeds 700MB, it displays the playback screen or download button.
    1.  **Less than 700MB**
      <figure data-layout="center" data-align="center">
