...
<DescriptionCards num="2">
  <DescriptionCards.Card
    title="Overview"
    description="Overall product understanding and key features"
    href="/en/querypie-overview"
    icon={<BookOpenIcon />}
    arrow
  />
  <DescriptionCards.Card
    title="User Manual"
    description="Basic usage and feature learning"
    href="/en/user-manual"
    icon={<UserIcon />}
    arrow
  />
...
<DescriptionCards num="2">
  <DescriptionCards.Card
    ...
    description="Configuration and security policy management"
...
* **[QueryPie ACP Community Edition Installation Guide](https://www.querypie.com/en/features/documentation/querypie-install-guide)** - Free installation and trial guide
