...
* URL for links to download AiDD scan results (AiDD is a feature removed after 11.1.0)
* URL for links to download session recording files
* QueryPie host information required in Proxy environments
* URL used for generating the Issuer URL and verifying the issuer of issued tokens during OAuth authentication integration
