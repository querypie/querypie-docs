...
This guide provides instructions for operating QueryPie Server Container on Virtual Machines running on On-Premise physical servers.
...
* Apply L7 Load Balancer and L4 Load Balancer for a configuration suitable for high availability and load balancing.
