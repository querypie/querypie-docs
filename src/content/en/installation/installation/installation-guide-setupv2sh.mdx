...
`setup.v2.sh` automatically performs the following main installation procedures.
...
You may need to change Firewall, AWS Security Group settings by referring to network connection configuration: [System Architecture and Network Access Control](../system-architecture-and-network-access-control)
...
After installation is complete, you need to perform initial configuration according to your operating environment.
