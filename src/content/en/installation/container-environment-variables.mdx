...
* ⚠️ User Agent users must delete (uninstall) the installed User Agent and then reinstall it.

If you are unsure what value to generate initially, you can use a value generated by `uuidgen | tr -d '-'` in a Linux terminal.
...
Please refer to the [Environment Variables for Advanced Setup - 10.3.x (KO)](https://querypie.atlassian.net/wiki/spaces/QCP/pages/954597480) page.
