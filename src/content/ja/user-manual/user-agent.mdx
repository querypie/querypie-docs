...
4. インストール完了されたQueryPie Agentを実行します。
...
次の方法で.sshフォルダにconfigファイルを作成して簡単にseamless SSH設定が可能です。
...
<Callout type="info">
configファイル作成時Seamless SSH設定したいサーバーごとにサーバー名、URL、ポートを入力することでサーバーを特定します。
