...
<img src="/user-manual/database-access-control/connecting-with-web-sql-editor/image-20251218-115500.png" alt="User &gt; Databasesのコネクション選択および接続画面" width="760" />
<figcaption>
...
* `Auto commit` : 実行した作業クエリの自動コミットを有効化します。
...
Ledger政策または接続政策によってクエリ実行時に理由入力が強制される場合があります。
