...
*  **Request Type**  ：決裁規則を追加する要求タイプを選択します。決裁規則は要求タイプ別に区分されます。
    * ⚠️ Request Typeは一度決裁規則を生成すると**変更できません。**
...
<figure data-layout="center" data-align="center">
<img src="/administrator-manual/general/workflow-management/approval-rules/screenshot-20240725-165423.png" alt="Administrator &gt; General &gt; Workflow Management &gt; Approval Rules (削除有効化)" width="760" />
<figcaption>
