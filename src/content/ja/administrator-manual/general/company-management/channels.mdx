...
<figure data-layout="center" data-align="center">
<img src="/administrator-manual/general/company-management/channels/screenshot-20240728-222004.png" alt="Administrator &gt; General &gt; Company Management &gt; Channels &gt; Delete確認モーダル" width="760" />
<figcaption>
...
<figure data-layout="center" data-align="center">
<img src="/administrator-manual/general/company-management/channels/image-20240305-110658.png" alt="Slack内Webhook追加画面" width="760" />
<figcaption>
Slack内Webhook追加画面
</figcaption>
</figure>

4. Workspace内に警報を送信するチャンネルを選択した後 `許可` ボタンをクリックします。
5. 生成されたWebhook URL情報をコピーした後、QueryPieチャンネル作成モーダルに貼り付けます。
...
7. OAuth & PermissionsページでBot User OAuth Tokenをコピーし、QueryPieチャンネル作成モーダルに貼り付けます。
  <figure data-layout="center" data-align="center">
  <img src="/administrator-manual/general/company-management/channels/screenshot-20240804-190835.png" alt="Slack内OAuth & Permissionsページ - トークンコピー" width="760" />
  <figcaption>
