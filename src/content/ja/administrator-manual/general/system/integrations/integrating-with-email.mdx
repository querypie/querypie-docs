...
3. 詳細ページにある`Configure`ボタンをクリックするとSMTP情報を入力できるポップアップが表示されます。<br/> <br/>
...
1. Administrator &gt; General &gt; System &gt; Integrationsメニューに移動します。
2. Emailタイルをクリックして詳細ページに移動します。
3. 詳細ページEmail senderに表示されたSMTP設定に対してEditボタンを押します。<br/> <br/>
  <figure data-layout="center" data-align="center">
...
1. Administrator &gt; General &gt; System &gt; Integrationsメニューに移動します。
2. Emailタイルをクリックして詳細ページに移動します。
3. Sent Email Historyリストを確認します。<br/>このリストに保存されるemail送信履歴は30日間保管され30日以前の内容は削除されます。<br/> <br/>
  <figure data-layout="center" data-align="center">
...
<Callout type="info">
QueryPie 10.2.2からGoogle OTPとともにEmailを2次認証手段として使用できるようになりました。
Email Integration設定がまず必要です。
</Callout>
