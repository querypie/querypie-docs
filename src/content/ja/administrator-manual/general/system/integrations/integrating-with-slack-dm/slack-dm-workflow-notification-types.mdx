...
<img src="/administrator-manual/general/system/integrations/integrating-with-slack-dm/slack-dm-workflow-notification-types/image-20231003-062427.png" alt="一般モード承認リクエスト例（左）/ 事後承認モード承認リクエスト例（右）" width="760" />
<figcaption>
