...
既存の元帳テーブルポリシー機能は別途ライセンスで提供されていましたが、10.2.1バージョンから別途ライセンスなしでDAC統合機能として提供されます。
</Callout>
...
* [Ledger Table Policy](ledger-management/ledger-table-policy)
* [Ledger Approval Rules](ledger-management/ledger-approval-rules)
