...
QueryPieを通じて接続したサーバーで実行したコマンドを記録します。
Windows Serverの場合、マウスクリック、キーボード入力、実行プロセス名を記録します。

### Command Auditの照会

<figure data-layout="center" data-align="center">
<img src="/administrator-manual/audit/server-logs/command-audit/image-20240728-171227.png" alt="Administrator &gt; Audit &gt; Servers &gt; Command Audit" width="760" />
<figcaption>
...
* 検索フィールド右側フィルターボタンをクリックしてAND/OR条件で以下のフィルタリングが可能です。
  <figure data-layout="center" data-align="center">
  <img src="/administrator-manual/audit/server-logs/command-audit/image-20240728-171533.png" alt="image-20240728-171533.png" width="671" />
  </figure>
    *  **Server OS**  : 接続したサーバーのOS
    *  **Protocol** : 接続時に使用したProtocol
    *  **Executed From** : 接続方式
...
<figure data-layout="center" data-align="center">
<img src="/administrator-manual/audit/server-logs/command-audit/image-20250930-083734.png" alt="フィルターのAction Typeで複数の項目を選択した例" width="598" />
<figcaption>
...
<figure data-layout="center" data-align="center">
<img src="/administrator-manual/audit/server-logs/command-audit/image-20241209-125101.png" alt="Administrator &gt; Audit &gt; Servers &gt; Command Audit &gt; Command Audit Details" width="760" />
<figcaption>
