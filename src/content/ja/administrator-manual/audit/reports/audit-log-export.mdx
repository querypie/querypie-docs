...
- DB Access History中特定データベース2種類のみ抽出したい場合に必要な表現式: `connectionName == 'database1' || connectionName == 'database2'`

- DB Access History中特定データベース2種類でありながらReplication TypeがSINGLEの場合のみ抽出したい場合に必要な表現式: `(connectionName == 'database1' || connectionName == 'database2') && replicationType == 'SINGLE'`
</Callout>
