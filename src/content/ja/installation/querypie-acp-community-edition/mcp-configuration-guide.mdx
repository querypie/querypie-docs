...
<img src="/installation/querypie-acp-community-edition/mcp-configuration-guide/image-20251211-091753.png" alt="MCP server追加" width="760" />
<figcaption>
MCP server追加
</figcaption>
</figure>
...
まず`/mcp`を入力して現在設定されているMCP Serverの状態を確認します。
...
<figure data-layout="center" data-align="center">
<img src="/installation/querypie-acp-community-edition/mcp-configuration-guide/image-20251214-232657.png" alt="claude mcp listコマンド実行結果" width="542" />
<figcaption>
...
<figure data-layout="center" data-align="center">
<img src="/installation/querypie-acp-community-edition/mcp-configuration-guide/image-20251214-232033.png" alt="クエリ例" width="760" />
<figcaption>
クエリ例
</figcaption>
</figure>
...
<figure data-layout="center" data-align="center">
<img src="/installation/querypie-acp-community-edition/mcp-configuration-guide/image-20251214-232144.png" alt="回答例" width="760" />
<figcaption>
回答例
</figcaption>
</figure>
...
Gemini CLIで`/mcp auth`コマンドを使用して認証します。
```
 /mcp auth acp
```
