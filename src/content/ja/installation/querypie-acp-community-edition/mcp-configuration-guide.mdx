...
* `Authenticate`を選択します。<br/>
  <figure data-layout="center" data-align="center">
  ![image-20251211-092454.png](/installation/querypie-acp-community-edition/mcp-configuration-guide/image-20251211-092454.png)
  </figure>
* ブラウザが開いたら、QueryPieログインページでログインします。 <br/>正常にログインすると、ブラウザに「Authentication Successful」メッセージが表示されます。<br/> <br/> Claude Codeでも「Authentication successful. Connect to querypie.」メッセージが表示されます。 <br/> 
  <figure data-layout="center" data-align="center">
...
* 次のコマンドで接続を確認します: `claude mcp list`
* クエリを通じて作業を実行してみます。<br/> <br/> 
  <figure data-layout="center" data-align="center">
...
/mcp auth acp
  ```
* ブラウザが開いたら、QueryPieログインページでログインします。 <br/>正常にログインすると、ブラウザに「Authentication Successful」メッセージが表示されます。<br/>
  <figure data-layout="center" data-align="center">
...
* 各ToolはACP権限システム（`@Authorization`）に従います。
