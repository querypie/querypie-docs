...
* setup.shで製品を既にインストールしたサーバにsetup.v2.shを利用して新しいバージョンをインストールできます。しかしMySQL Data Dir変更に従って**既存データが自動的に移管されません**。新しいインストール、アップグレードなど目的に従ってインストール担当者がMySQL Dataディレクトリを適切に移動する必要があります。
...
Dockerを使用する場合、別途文書を参照してRootless Mode設定を実行する必要があります。
