...
* Hardware性能と容量
    ...
    * 数百名以上の利用者が多くのトラフィックで利用する場合、8 vCPUs、32 GiB Memoryを推奨仕様として提示します。
    * Root file systemのサイズを100 GiB以上で構成することを推奨します。
* CPU Architecture
    ...
    * <Badge color="yellow">BETA</Badge> QueryPie version 11.1.1からApple Silicon CPUを使用するmacOS環境をサポートします。
